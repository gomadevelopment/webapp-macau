<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="card-body p-0 mb-3 ml-1" style="background:none; box-shadow: none;">
            <label class="label_title">Apagar Professores</label>
        </div>
                                    ...
                                    <tr id="{{ $professor->id }}">
                                        ...
                                        <td>
                                            <div class="dash_action_link" style="text-align-last: center;">
                                                <a href="/acoes-irreversiveis/apagar/professor/{{ $professor->id }}" class="delete cancel" delete-who="professor" data-id="{{ $professor->id }}">Apagar</a>
                                            </div>	
                                        </td>
                                    </tr>
                                @endforeach
