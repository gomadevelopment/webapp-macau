<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="card-body p-0 mb-3 ml-1" style="background:none; box-shadow: none;">
            <label class="label_title">Apagar Alunos</label>
        </div>
                                    ...
                                    <tr id="{{ $student->id }}">
                                        ...
                                        <td>
                                            <div class="dash_action_link">
                                                <a href="/acoes-irreversiveis/apagar/aluno/{{ $student->id }}" class="delete cancel" delete-who="student" data-id="{{ $student->id }}">Apagar</a>
                                            </div>	
                                        </td>
                                    </tr>
                                @endforeach
