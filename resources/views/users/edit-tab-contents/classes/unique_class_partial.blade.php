<div class="shop_grid_caption card-body m-0 mb-4 pt-2 pb-2">
    ...
    <div class="form-group d-flex flex-wrap justify-content-center m-0">
        <img src="{{asset('/assets/backoffice_assets/icons/Classes.svg', config()->get('app.https'))}}?v=2.4" class="ml-2 mr-2" alt="" style="margin-bottom: 4px;">
    ...
    <div id="collapse_class_{{ $class->id }}" class="collapse" data-parent="#accordion">
        ...
        <div class="exercise_time wrap mt-3 mb-4 text-left">
            ...
            <a href="#" class="btn btn-theme float-none remove_button m-2" style="padding: 13px 20px;">
                <img src="{{asset('/assets/backoffice_assets/icons/performance_icon_pink.svg', config()->get('app.https'))}}?v=2.4" alt="" style="margin-right: 5px; margin-bottom: 2px;">
                Ver Desempenho
            </a>
        </div>
                    ...
                    <div class="dropdown ml-auto align-self-center classes_student_dropdown student_dropdown">
                        ...
                        <div class="dropdown-menu message-box">
                            <a class="msg-title" href="/perfil/{{ $student->id }}">
                                <img src="{{asset('/assets/backoffice_assets/icons/USer.svg', config()->get('app.https'))}}?v=2.4" class="logo logout_icon ml-1 mr-1 mb-1" alt="" />
                                Ver Perfil do Aluno
                            </a>
                            <hr class="mt-0 mb-2 ml-2 mr-2">
                            <a class="msg-title" href="/chat/{{ $student->id }}">
                                <img src="{{asset('/assets/backoffice_assets/icons/Chat_black.svg', config()->get('app.https'))}}?v=2.4" class="logo logout_icon mr-1" alt="" />
                                Iniciar Conversa
                            </a>
                            <hr class="mt-0 mb-2 ml-2 mr-2">
                            <a class="msg-title remove_student_button" href="#" data-student-id="{{ $student->id }}" data-class-id="{{ $class->id }}">
                                <img src="{{asset('/assets/backoffice_assets/icons/Cross_black.svg', config()->get('app.https'))}}?v=2.4" class="logo logout_icon ml-1 mr-2" alt="" />
