                        ...
                        <div class="row replace_user_avatar_row">
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                ...
                                <a href="#" id="replace_user_avatar" class="btn search-btn comment_submit mt-4 mb-4" style="float: none; padding: 12px 20px;">
                                    <img src="{{asset('/assets/backoffice_assets/icons/Upload_white.svg', config()->get('app.https'))}}?v=2.4" alt="" style="margin-right: 5px; margin-bottom: 2px;">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                <div class="d-block text-right mt-2">
                                    <a href="/perfil/{{ $user->id }}" class="btn btn-theme remove_button m-2" style="float: none; padding: 12px 20px;">
                                        <img src="{{asset('/assets/backoffice_assets/icons/eye_outline.svg', config()->get('app.https'))}}?v=2.4" alt="" style="margin-right: 5px; margin-bottom: 2px;">
                                        Ver o meu Perfil
                                    </a>
                                    <button class="btn search-btn comment_submit m-2" style="float: none; padding: 12px 20px;">
                                        Gravar
                                        <img src="{{asset('/assets/backoffice_assets/icons/save.svg', config()->get('app.https'))}}?v=2.4" alt="" style="margin-left: 10px; margin-bottom: 2px;">
                                    </button>
                                </div>
                            </div>
