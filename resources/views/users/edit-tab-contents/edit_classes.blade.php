        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="shop_grid_caption card-body m-0 mb-4 pt-2 pb-2">
                    ...
                    <div class="form-group d-flex flex-wrap justify-content-center m-0">
                        <h4 class="sg_rate_title align-self-center m-0" style="font-size: 21px;">
                            ...
                            Turma A > University of St. Joseph
                        </h4>
                        <br>
                        <a  href="#collapse_class_A" class="ml-auto b-0 align-self-center expand_accordion collapsed"  data-toggle="collapse" data-parent="#accordion">
                ...
                <div class="shop_grid_caption card-body classroom m-0 mb-4 pt-0 pb-0">
                    ...
                    <div id="collapse_class_A" class="collapse" data-parent="#accordion">
                        ...
                        <div class="form-group d-flex flex-wrap mb-4">
                            <img src="https://via.placeholder.com/500x500" alt="" class="colleagues_round_avatar mr-3">
                            <h4 class="colleagues_name m-0">Rui Caparinha</h4>
                            <div class="dropdown ml-auto align-self-center classes_student_dropdown student_dropdown">
                                <a href="#" class="messages" data-toggle="dropdown" aria-expanded="false">
                                    <span class="ping"></span>
                                    <img src="{{asset('/assets/backoffice_assets/icons/Dots.svg')}}" class="empty_dots" alt="">
                        ...
                        <div class="form-group d-flex flex-wrap mb-4">
                            <img src="https://via.placeholder.com/500x500" alt="" class="colleagues_round_avatar mr-3">
                            <h4 class="colleagues_name m-0">José Miguel Santos</h4>
                            <div class="dropdown ml-auto align-self-center classes_student_dropdown student_dropdown">
                                <a href="#" class="messages" data-toggle="dropdown" aria-expanded="false">
                                    <span class="ping"></span>
                                    <img src="{{asset('/assets/backoffice_assets/icons/Dots.svg')}}" class="empty_dots" alt="">
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="shop_grid_caption card-body m-0 mb-4 pt-2 pb-2">
                    ...
                    <div class="form-group d-flex flex-wrap justify-content-center m-0">
                        <h4 class="sg_rate_title align-self-center m-0" style="font-size: 21px;">
                            <img src="{{asset('/assets/backoffice_assets/icons/Classes.svg')}}" class="mr-2" alt="">
                            Turma C > University of St. Joseph
                        </h4>
                        <br>
                        <a  href="#collapse_class_C" class="ml-auto b-0 align-self-center expand_accordion collapsed"  data-toggle="collapse" data-parent="#accordion">
                            <img src="{{asset('/assets/backoffice_assets/icons/Chevron_black.svg')}}" class="expand_chevron" alt="">
                            <img src="{{asset('/assets/backoffice_assets/icons/Chevron_up_pink.svg')}}" class="collapse_chevron" alt="" style="display: none;">
                        </a>
                    </div>
                ...
                <div class="shop_grid_caption card-body classroom m-0 mb-4 pt-0 pb-0">
                    ...
                    <div id="collapse_class_C" class="collapse" data-parent="#accordion">
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="shop_grid_caption card-body m-0 mb-4 pt-2 pb-2">
                    ...
                    <div class="form-group d-flex flex-wrap justify-content-center m-0">
                        <h4 class="sg_rate_title align-self-center m-0" style="font-size: 21px;">
                            <img src="{{asset('/assets/backoffice_assets/icons/Classes.svg')}}" class="mr-2" alt="">
                            Turma B > University of St. Joseph
                        </h4>
                        <br>
                        <a  href="#collapse_class_B" class="ml-auto b-0 align-self-center expand_accordion collapsed"  data-toggle="collapse" data-parent="#accordion">
                            <img src="{{asset('/assets/backoffice_assets/icons/Chevron_black.svg')}}" class="expand_chevron" alt="">
                            <img src="{{asset('/assets/backoffice_assets/icons/Chevron_up_pink.svg')}}" class="collapse_chevron" alt="" style="display: none;">
                        </a>
                    </div>
                ...
                <div class="shop_grid_caption card-body classroom m-0 mb-4 pt-0 pb-0">
                    ...
                    <div id="collapse_class_B" class="collapse" data-parent="#accordion">
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="shop_grid_caption card-body m-0 mb-4 pt-2 pb-2">
                    ...
                    <div class="form-group d-flex flex-wrap justify-content-center m-0">
                        <h4 class="sg_rate_title align-self-center m-0" style="font-size: 21px;">
                            <img src="{{asset('/assets/backoffice_assets/icons/Classes.svg')}}" class="mr-2" alt="">
                            Turma D > University of St. Joseph
                        </h4>
                        <br>
                        <a  href="#collapse_class_D" class="ml-auto b-0 align-self-center expand_accordion collapsed"  data-toggle="collapse" data-parent="#accordion">
                            <img src="{{asset('/assets/backoffice_assets/icons/Chevron_black.svg')}}" class="expand_chevron" alt="">
                            <img src="{{asset('/assets/backoffice_assets/icons/Chevron_up_pink.svg')}}" class="collapse_chevron" alt="" style="display: none;">
                        </a>
                    </div>
                ...
                <div class="shop_grid_caption card-body classroom m-0 mb-4 pt-0 pb-0">
                    ...
                    <div id="collapse_class_D" class="collapse" data-parent="#accordion">
