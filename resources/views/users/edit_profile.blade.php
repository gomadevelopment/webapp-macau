                ...
                <ul class="nav nav-tabs p-2 b-0" id="edit_profile_tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link {{ isset($inputs['land_on_settings_tab']) && $inputs['land_on_settings_tab'] ? '' : 'active' }}" 
                            ...
                            <img src="{{asset('/assets/backoffice_assets/icons/info.svg', config()->get('app.https'))}}?v=2.4" class="white_icon" alt="" style="margin-bottom: 3px; margin-right: 5px;">
                            <img src="{{asset('/assets/backoffice_assets/icons/info_black.svg', config()->get('app.https'))}}?v=2.4" class="black_icon" alt="" style="margin-bottom: 3px; margin-right: 5px;">
                            Informação</a>
                    </li>
                    @if($user->id == auth()->user()->id)
                        <li class="nav-item">
                            <a class="nav-link" id="notifications-tab" data-toggle="tab" href="#notifications" role="tab" aria-controls="notifications-tab" aria-selected="false">
                                <img src="{{asset('/assets/backoffice_assets/icons/bell_icon_white.svg', config()->get('app.https'))}}?v=2.4" class="white_icon" alt="" style="margin-bottom: 3px; margin-right: 5px;">
                                <img src="{{asset('/assets/backoffice_assets/icons/bell_icon_black.svg', config()->get('app.https'))}}?v=2.4" class="black_icon" alt="" style="margin-bottom: 3px; margin-right: 5px;">
                                Notificações</a>
                        </li>
                        @if(auth()->user()->isProfessor() && auth()->user()->isActive())
                            <li class="nav-item">
                                <a class="nav-link" id="classes-tab" data-toggle="tab" href="#classes" role="tab" aria-controls="classes-tab" aria-selected="false">
                                    <img src="{{asset('/assets/backoffice_assets/icons/Classes_white.svg', config()->get('app.https'))}}?v=2.4" class="white_icon" alt="" style="margin-bottom: 3px; margin-right: 5px;">
                                    <img src="{{asset('/assets/backoffice_assets/icons/Classes.svg', config()->get('app.https'))}}?v=2.4" class="black_icon" alt="" style="margin-bottom: 3px; margin-right: 5px;">
                                    Turmas</a>
                            </li>
                            @if(auth()->user()->isAdmin())
                                <li class="nav-item">
                                    <a class="nav-link {{ isset($inputs['land_on_settings_tab']) && $inputs['land_on_settings_tab'] ? 'active' : '' }}"
                                        ...
                                        <img src="{{asset('/assets/backoffice_assets/icons/cog_white.svg', config()->get('app.https'))}}?v=2.4" class="white_icon" alt="" style="margin-bottom: 3px; margin-right: 5px;">
                                        <img src="{{asset('/assets/backoffice_assets/icons/cog.svg', config()->get('app.https'))}}?v=2.4" class="black_icon" alt="" style="margin-bottom: 3px; margin-right: 5px;">
                                        Definições</a>
                                </li>
                            @endif
                        @endif
