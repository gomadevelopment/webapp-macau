<div class="form-group to_choose information">
    ...
    <form id="form-information" class="question-form" action=""  enctype="multipart/form-data">
        ...
        <label class="label_title mb-3" style="font-size: 30px;">
            Texto Informativo <img src="{{asset('/assets/backoffice_assets/icons/Tooltip.svg')}}" data-toggle="tooltip" title="Estas Tooltips servem para explicar ao Utilizador como usar o módulo." alt="" style="margin-left: 5px;"></label>
        <div class="row">
            <div class="col-12">
