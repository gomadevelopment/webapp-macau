{{-- <div class="custom-tab customize-tab tabs_creative to_choose fill_split">
    ...
    {{-- <div class="tab-content mt-4" id="fill_split_tabs_content">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12 mb-3">
                        <div class="p-4" style="background-color: #f1f6f9; border-radius: 10px; box-shadow: 0 13px 26px 13px rgba(0, 0, 0, 0.01);">
                            <textarea class="form-control" name="fill_textarea_0" id="fill_textarea_0" cols="30" rows="4" placeholder=""></textarea>
                        </div>
                        ...
                        <div class="d-block float-right mt-3">
                            <a href="#" id="fill_associate_media_file_button_0" class="btn search-btn comment_submit" style="float: none; padding: 16px 20px; margin-left: 15px;">
                                <img src="{{asset('/assets/backoffice_assets/icons/Upload_white.svg')}}" alt="" style="margin-right: 10px; margin-bottom: 2px;">
                                Associar Media
                            </a>
                            <input type="file" name="fill_associate_media_file_input_0" id="fill_associate_media_file_input_0" hidden disabled>
                        </div>
                    </div>
                </div>
                <div class="row mb-3">
        ...
        <div class="tab-pane fade" id="split" role="tabpanel" aria-labelledby="split-tab">
            ...
            <div class="form-group">
                <div class="row mb-3">
                    <div class="col-12">
                        <label class="label_title text_number">
                            <span>Texto 1</span>
                        </label>
                    </div>
                    <div class="col-sm-12 col-md-12 col-lg-12 mb-3">
                        <div class="p-4" style="background-color: #f1f6f9; border-radius: 10px; box-shadow: 0 13px 26px 13px rgba(0, 0, 0, 0.01);">
                            <textarea class="form-control" name="split_textarea_0" id="split_textarea_0" cols="30" rows="5" placeholder=""></textarea>
                        </div>
                    </div>
                </div>
                <div class="row mb-3">
...
<div class="add_split_clone2" hidden>
    <div class="col-12">
        <label class="label_title question_number">
            <span>Texto 1</span>
        </label>
