<div class="row">
    <div class="col-sm-12 col-md-6 col-lg-4 mb-5" {{ isset($details_page) && $details_page ? 'hidden' : '' }}>
        <div class="card-body">
            <div class="form-group">
                <label class="label_title">Criar a partir de outro Exercício <img src="{{asset('/assets/backoffice_assets/icons/Tooltip.svg', config()->get('app.https'))}}?v=2.4" data-toggle="tooltip" 
    ...
    <div class="col-sm-12 col-md-12 col-lg-3 text-center">
        <img src="{{asset('/assets/backoffice_assets/images/lamp.svg', config()->get('app.https'))}}?v=2.4" alt="" style="contain: style;">
    </div>
</div>
