        ...
        <div class="col-sm-12 col-md-12 col-lg-12">
            <div class="form-group">
                ...
                <div class="w-100">
                    ...
                    <textarea class="form-control" name="{{$question->id}}_automatic_content[{{$item->id}}]" id="" cols="30" rows="5" {{ $exame_review ? 'readonly' : '' }}>{{ $exame_review ? $item->options_answered : str_replace(" ","",$item->text_1) }}</textarea>

                </div>

                @if($exame_review)
                    @if($item->text_1 == $item->options_answered)
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="form-group">
                    ...
                    <div class="w-100">
                        ...
                        <textarea class="form-control" name="" id="" cols="30" rows="5" readonly>{{ $item->text_1 }}</textarea>
