<div class="row mb-4" id="quiz-div">
    <div class="col-sm-12 col-md-12 col-lg-12">
        <div class="card-body" id="inquiries_card_body">
            ...
            <div class="row page-title p-0" style="margin-bottom: -15px;">
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="form-group wrap m-0">
                        ...
                        <label class="label_title d-block cnn_label" style="font-size: 30px;">
                            波斯埃斯库塔 </label>
                    </div>
                    <ul class="exercise_time wrap see_in_english float-right align-items-center inquiries_ul">
                        <li class="language_button ml-3 active">
                            <a href="#" class="pt_language_button" data-language="pt">PT</a>
                        </li>
                        <li class="language_slash">
                            <a href="#">|</a>
                        </li>
                        <li class="language_button">
                            <a href="#" class="en_language_button" data-language="en">EN</a>
                        </li>
                        <li class="language_slash">
                            <a href="#">|</a>
                        </li>
                        <li class="language_button">
                            <a href="#" class="cnn_language_button" data-language="cnn">CHN</a>
                        </li>
                ...
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="form-group">
                        ...
                        <label class="label_title mb-3 d-block en_label">
                            Quiz </label>
                        <label class="label_title mb-3 d-block cnn_label">
                            测验 </label>
                        ...
                        <div class="d-flex float-left flex-column cnn_label">
                            <p class="exercise_author" style="margin-bottom: -10px;">
                                <strong>回顧您所做的題目以及您的答題策略.</strong> 回答以下的問題:
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mt-5 mb-5 text-center pr-5 pl-5">
                <div class="col-xs-6 col-sm-6 col-md-4 col-lg-2 mb-3">
                    ...
                    <div class="quiz_level_label cnn_label" style="cursor: default; pointer-events: none;">
                        完全不同意
                    </div>
                </div>
                <div class="col-xs-6 col-sm-6 col-md-4 col-lg-2 mb-3">
            ...
            <div class="row mb-4">
                @if($exame_review)
                    @foreach($exame->inquiries->shuffle() as $exame_inquiry)
                            ...
                            <div class="form-group quiz_question_div rb-box p-3">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-7 col-lg-7 align-self-center">
                                        ...
                                        <div class="question cnn_label">
                                            <strong>题 {{ $loop->index + 1 }}:</strong> {{ $exame_inquiry->inquirie->question_cnn }}
                                        </div>
                                    </div>
                    ...
                    @endforeach
                @else
                    @foreach($inquiries->shuffle() as $inquiry)
                            ...
                            <div class="form-group quiz_question_div rb-box p-3">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-7 col-lg-7 align-self-center">
                                        ...
                                        <div class="question cnn_label">
                                            <strong>题 {{ $loop->index + 1 }}:</strong> {{ $inquiry->question_cnn }}
                                        </div>
                                    </div>
            ...
            <div class="row mb-4">
                ...
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="form-group">
                        ...
                        <label class="label_title d-block en_label" style="font-size: 30px;">
                        {{ $anxiety_inquiry->question_en }} </label>
                        <label class="label_title d-block cnn_label" style="font-size: 30px;">
                        {{ $anxiety_inquiry->question_cnn }} </label>
                        ...
                        <div class="d-flex flex-column cnn_label">
                            <p class="exercise_author" style="margin-bottom: -10px;">
                                用1分至5分來評定您對關於聽力題目的焦慮程度
                            </p>
                        </div>

                        <div class="row mt-4 text-center justify-content-center pr-5 pl-5 rb anxiety_levels" id="rb-15" data-id="15">
                            <div class="col-xs-6 col-sm-6 col-md-4 col-lg-2 mb-3 rb-tab anxiety_levels_rb-tab
                             {{ ($exame_review && $exame->anxiety_inquiry->value == 1) || !$exame_review ? 'rb-tab-active' : '' }}" data-value="1">
                                <div class="rb-spot anxiety_levels_rb-spot one" style="{{ $exame_review ? 'cursor: default; pointer-events: none;' : '' }}">
                                    <span class="rb-txt anxiety_levels_tb-txt pt-1"></span>
                                </div>
                                <div class="quiz_level_label pt_label" style="{{ $exame_review ? 'cursor: default; pointer-events: none;' : '' }}">
                                    1 - Não senti Ansiedade nenhuma
                                </div>
                                <div class="quiz_level_label en_label" style="{{ $exame_review ? 'cursor: default; pointer-events: none;' : '' }}">
                                    1 - Didn't feel Anxiety at all
                                </div>
                                <div class="quiz_level_label cnn_label" style="{{ $exame_review ? 'cursor: default; pointer-events: none;' : '' }}">
                                    1 - 我完全没有焦慮
                                </div>
                            </div>
                            <div class="col-xs-6 col-sm-6 col-md-4 col-lg-2 mb-3 rb-tab anxiety_levels_rb-tab
                            {{ $exame_review && $exame->anxiety_inquiry->value == 2 ? 'rb-tab-active' : '' }}" data-value="2">
                                <div class="rb-spot anxiety_levels_rb-spot two" style="{{ $exame_review ? 'cursor: default; pointer-events: none;' : '' }}">
                                    <span class="rb-txt anxiety_levels_tb-txt pt-1"></span>
                                </div>
                                <div class="quiz_level_label pt_label" style="{{ $exame_review ? 'cursor: default; pointer-events: none;' : '' }}">
                                    2 - Não senti Ansiedade
                                </div>
                                <div class="quiz_level_label en_label" style="{{ $exame_review ? 'cursor: default; pointer-events: none;' : '' }}">
                                    2 - Didn't feel Anxiety
                                </div>
                                <div class="quiz_level_label cnn_label" style="{{ $exame_review ? 'cursor: default; pointer-events: none;' : '' }}">
                                    2 - 我不感到焦慮
                                </div>
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-4 col-lg-2 mb-3 rb-tab anxiety_levels_rb-tab
                            {{ $exame_review && $exame->anxiety_inquiry->value == 3 ? 'rb-tab-active' : '' }}" data-value="3">
                                <div class="rb-spot anxiety_levels_rb-spot three" style="{{ $exame_review ? 'cursor: default; pointer-events: none;' : '' }}">
                                    <span class="rb-txt anxiety_levels_tb-txt pt-1"></span>
                                </div>
                                <div class="quiz_level_label pt_label" style="{{ $exame_review ? 'cursor: default; pointer-events: none;' : '' }}">
                                    3 - Senti pouca Ansiedade
                                </div>
                                <div class="quiz_level_label en_label" style="{{ $exame_review ? 'cursor: default; pointer-events: none;' : '' }}">
                                    3 - Felt a little Anxiety
                                </div>
                                <div class="quiz_level_label cnn_label" style="{{ $exame_review ? 'cursor: default; pointer-events: none;' : '' }}">
                                    3 - 我感到一點點焦慮
                                </div>
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-4 col-lg-2 mb-3 rb-tab anxiety_levels_rb-tab
                            {{ $exame_review && $exame->anxiety_inquiry->value == 4 ? 'rb-tab-active' : '' }}" data-value="4">
                                <div class="rb-spot anxiety_levels_rb-spot four" style="{{ $exame_review ? 'cursor: default; pointer-events: none;' : '' }}">
                                    <span class="rb-txt anxiety_levels_tb-txt pt-1"></span>
                                </div>
                                <div class="quiz_level_label pt_label" style="{{ $exame_review ? 'cursor: default; pointer-events: none;' : '' }}">
                                    4 - Senti Ansiedade
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-4 col-lg-2 mb-3 rb-tab anxiety_levels_rb-tab
                            {{ $exame_review && $exame->anxiety_inquiry->value == 5 ? 'rb-tab-active' : '' }}" data-value="5">
                                <div class="rb-spot anxiety_levels_rb-spot five" style="{{ $exame_review ? 'cursor: default; pointer-events: none;' : '' }}">
                                    <span class="rb-txt anxiety_levels_tb-txt pt-1"></span>
                                </div>
                                <div class="quiz_level_label pt_label" style="{{ $exame_review ? 'cursor: default; pointer-events: none;' : '' }}">
                                    5 - Senti muita Ansiedade
                                </div>
                                <div class="quiz_level_label en_label" style="{{ $exame_review ? 'cursor: default; pointer-events: none;' : '' }}">
                                    5 - Felt a lot of Anxiety
                                </div>
                                <div class="quiz_level_label cnn_label" style="{{ $exame_review ? 'cursor: default; pointer-events: none;' : '' }}">
                                    5 - 我感到非常焦慮
                                </div>
