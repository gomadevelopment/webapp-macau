<div class="row">
    ...
    <?php $students_with_exames_awaiting_evaluation = false; ?>

    @foreach ($students_exames_awaiting_evaluation as $student)
        @if(!$student->exames_awaiting_evaluation->count())
            <?php $students_with_exames_awaiting_evaluation = $students_with_exames_awaiting_evaluation ? true : false; ?>
            @continue
        @else
            <?php $students_with_exames_awaiting_evaluation = true; ?>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="shop_grid_caption card-body m-0 mb-4">
                        ...
                        <h4 class="sg_rate_title align-self-center m-0">
                            ...
                            <div class="d-flex flex-row">
                                ...
                                <p class="exercise_author align-self-center">
                                    <strong>Exercícios:</strong> {{ $student->exames_awaiting_evaluation->count() }}
                                </p>
                            </div>
                        </h4>
                        <br>
                        <a href="#collapse_student_{{ $student->id }}_exames_awaiting_evaluation" class="ml-auto align-self-center expand_accordion collapsed"  data-toggle="collapse" data-parent="#accordion">
                            <span>Expandir</span>
                    ...
                    <div id="collapse_student_{{ $student->id }}_exames_awaiting_evaluation" class="collapse" data-parent="#accordion">

                        @foreach ($student->exames_awaiting_evaluation as $exame)
                            ...
                            <div class="mt-4" style="display: flow-root;">
                                ...
                                <div class="d-block float-right mt-3">
                                    <a href="/exercicios/corrigir/{{ $exame->id }}/aluno/{{ $student->id }}" class="btn search-btn comment_submit" style="float: none; padding: 12px 20px; margin-left: 15px;">
            ...
            <div class="shop_grid">
                <div class="shop_grid_caption">
                    <h4 class="sg_rate_title" style="font-size: 20px;">
                        Não foram encontrados alunos com exercícios que aguardem avaliação.
                    </h4>
                </div>
            </div>
        </div>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                {{ $students_exames_awaiting_evaluation->links('layouts.pagination-macau') }}
