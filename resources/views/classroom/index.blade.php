...
@section('scripts')
    ...
    <script src="{{asset('/assets/js/webapp-macau-custom-js/classroom.js', config()->get('app.https')) }}?v=1.9"></script>
    ...
    {{-- HighCharts --}}
    <script src="https://code.highcharts.com/highcharts.js?v=1.9"></script>
    <script src="https://code.highcharts.com/modules/data.js?v=1.9"></script>
    <script src="https://code.highcharts.com/modules/series-label.js?v=1.9"></script>
    <script src="https://code.highcharts.com/modules/exporting.js?v=1.9"></script>
    <script src="https://code.highcharts.com/modules/export-data.js?v=1.9"></script>
    <script src="https://code.highcharts.com/modules/accessibility.js?v=1.9"></script>
