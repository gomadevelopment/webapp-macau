        ...
        @foreach ($articles as $article)
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="shop_grid" style="min-height: 300px;">
                    ...
                    src="{{asset('/assets/backoffice_assets/icons/Heart.svg', config()->get('app.https'))}}?v=2.3" alt="" style="display: {{ $article->is_article_favorite ? 'none;' : 'block;' }}">
                        <img class="heart_filled_icon" data-article-id="{{ $article->id }}"
                            src="{{asset('/assets/backoffice_assets/icons/Heart_filled.svg', config()->get('app.https'))}}?v=2.3" alt="" style="display: {{ $article->is_article_favorite ? 'block;' : 'none;' }}">
                        ...
                        <div class="article_buttons">
                            @if(auth()->user()->id == $article->user_id)
                                <a href="/artigos/editar/{{ $article->id }}" class="btn btn-theme edit_button">
                                    <img src="{{asset('/assets/backoffice_assets/icons/Pencil.svg', config()->get('app.https'))}}?v=2.3" alt="">Editar
                                </a>
                                <a href="#" class="btn btn-theme remove_button remove_article" data-article-id="{{ $article->id }}">
                                    <img src="{{asset('/assets/backoffice_assets/icons/Cross.svg', config()->get('app.https'))}}?v=2.3" alt="">Remover
                                </a>
                            @endif
                        ...
                        <div class="read_more">
                            <a href="/artigos/detalhe/{{ $article->id }}" class="">Ler mais <img src="{{asset('/assets/backoffice_assets/icons/Add.svg', config()->get('app.https'))}}?v=2.3" alt="" style="margin: -1px 10px 3px 5px;"></a>
                        </div>
