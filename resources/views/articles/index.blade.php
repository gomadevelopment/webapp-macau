                ...
                <div class="col-lg-12 col-md-12">
                    ...
                    @if(auth()->user()->isProfessor())
                        <div class="dropdown create_article">
                            ...
                            <img src="{{asset('/assets/backoffice_assets/icons/Add_white.svg', config()->get('app.https'))}}?v=2.4" alt=""> 
                            Criar Artigo</a>
                        </div>
                    @endif
                    ...
                    <div class="dropdown order_by">
                        ...
                        Ordenar por <img src="{{asset('/assets/backoffice_assets/icons/Sort.svg', config()->get('app.https'))}}?v=2.4" alt="" style="margin-left: 10px;">
                        </a>
